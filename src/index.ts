...
const initialState: (number | null)[][] = [[4,5,8], [null,1,6], [7, 2, 3]];
...
const finalNode = runWhile(finalState, frontier, expandedStates);
if(finalNode){
    readNode(finalNode);
}

function runWhile(goalState: (number | null)[][], frontier: NodeInfo[], expandedStates: (number | null)[][][]){
